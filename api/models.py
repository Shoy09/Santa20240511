...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    class TipoUsuario(models.TextChoices):
        ...
        EMPLEADO_SUPERVISOR = 'Supervisor', 'Supervisor'
    ...
    def save(self, *args, **kwargs):
        try:
            ...
            if this.imagen_usuario != self.imagen_usuario:
                this.imagen_usuario.delete(save=False)
...
class ImportarAsistencia(models.Model):
    ...
    tipo_empleado = models.CharField(max_length=10, null=True)
...
class ImportarAsistenciaDetalle(models.Model):
    ...
    linea = models.CharField(max_length=30, null=True)
    idconsumidor = models.CharField(max_length=15, null=True)
...
class Registro(models.Model):
    ...
    FechaAbierto = models.CharField(max_length=8)  
...
class Externos(models.Model):
    ...
    id_general = models.CharField(max_length=8, blank=True)


class CondicionesImport(models.Model):
