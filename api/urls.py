...
router.register(r'condiciones-import', CondicionesImportViewSet)
...
urlpatterns = [
    ...
    path('anchoveta/asistencia/<str:idcodigogeneral>/<str:idlabor>/', ActualizacionAnchoveta.as_view(), name='actualizacion-anchoveta'),
...
#EXTERNOS-----------------------------------------------------
    ...
    path('externos/crear/masiva/', create_externo_pasivo, name='create_externo'),
    path('eliminar-todos-trabajadores/', EliminarTodosLosTrabajadores.as_view(), name='eliminar_todos_trabajadores'),
    path('externos/idgeneral/<str:id_general>/', ExternosDetailView.as_view(), name='externos-detail'),
