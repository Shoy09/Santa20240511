...
class AsistenciaDetalleSerializer(serializers.ModelSerializer):
    class Meta:
        model = ImportarAsistenciaDetalle
        fields = ['item', 'idcodigogeneral', 'idactividad', 'idlabor', 'linea', 'idconsumidor', 'cantidad', 'tipo_empleado', 'importar_asistencia']
...
class DetalleImportacionSerializer(serializers.ModelSerializer):
    class Meta:
        model = ImportarAsistenciaDetalle
        fields = ['item', 'idcodigogeneral', 'idactividad', 'idlabor', 'linea', 'idconsumidor', 'cantidad', 'tipo_empleado']
...
class ExternosSerializer(serializers.ModelSerializer):
    class Meta:
        model = Externos
        fields = ['dni', 'apellido_paterno', 'apellido_materno', 'nombres', 'nombre_apellido', 'id_general']
...
class ActualizacionAnchovetaSerializer(serializers.ModelSerializer):
    class Meta:
        model = ImportarAsistenciaDetalle
        fields = ['cantidad']


class CondicionesImportSerializer(serializers.ModelSerializer):
    class Meta:
        model = CondicionesImport
        fields = ['id', 'condicion', 'IDconexion', 'Peso']
